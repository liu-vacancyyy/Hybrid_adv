...
# Command attack is enabled on top of the randomized modes 0-1 command base.
...
export RC_HUMAN_ADV_EXP_NAME="${RC_HUMAN_ADV_EXP_NAME:-rc_human_adv_modes0_1_command_attack_ep880}"
exec sh "${SCRIPT_DIR}/train_rc_human_adversary.sh" --adv-command-random-base "$@"
