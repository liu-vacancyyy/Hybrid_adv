...
DEFAULT_ARGS = [
    ...
    '--model-name', 'GAZEBO',
    '--algorithm-name', 'ppo',
    '--experiment-name', 'vtol_mission_ground_ppo',
    '--cuda',
    '--device', 'cuda:0',
    ...
    '0.0', '0.0', '0.0', '0.0',
    '--lr', '0.00003',
    # The mission can last 70 s (3500 control steps).  A longer discount
    # horizon keeps the landing event visible from the transition phases.
    '--gamma', '0.999',
    '--gae-lambda', '0.98',
    '--entropy-coef', '0.01',
    '--target-kl', '0.03',
